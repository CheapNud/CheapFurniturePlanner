...
- [x] (2026-08-21 → 2026-08-22) updates: wire velopack once CheapAvaloniaBlazor ships it (currently 3.2.0, no update api): bump the package, add WithVelopackUpdates("http://192.168.1.15:3000/cheapnud/CheapFurniturePlanner") to the host builder, inject IUpdateService for a restart chip in the app bar [user]
