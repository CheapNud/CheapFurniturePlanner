...
- [ ] (2026-08-22) updates security: the velopack feed is plain http on the lan (mitm on the feed = arbitrary code execution); real fixes are tls at the forge (infra item) and package signing upstream in CheapAvaloniaBlazor - revisit when either lands [audit]
