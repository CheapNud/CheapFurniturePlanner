...
Work is tracked as issues on the forge board:
https://git.cheapludes.be/cheapnud/CheapFurniturePlanner/issues

Older entries that used to live in this file are still visible via `git log -p TODO.md`.
